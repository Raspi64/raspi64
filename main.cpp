...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        // 1. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            ImGui::Text("Here you can open a second window!");               // Display some text (you can use a format strings too)
            ImGui::Checkbox("Another Window", &show_another_window);


            if (ImGui::Button("Increment"))                            // Buttons return true when clicked (most widgets return true when edited/activated)
                counter++;
        ...
        ImGui::Begin("Zwei Fenster sind langweilig");
            ImGui::Text("I'm window number 3!");
